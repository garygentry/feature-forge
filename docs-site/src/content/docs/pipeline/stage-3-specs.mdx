...
- `/feature-forge:forge-verify <feature>` — strongly recommended before moving on. See [Verify & Fix](./verify-and-fix.mdx).
- `/feature-forge:forge-4-backlog <feature>` — see [Stage 4 · Backlog](./stage-4-backlog.mdx).
