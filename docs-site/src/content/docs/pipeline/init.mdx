...
For the full reference, see [forge.config.json](../advanced/config.mdx).
...
For deep bootstrap details, see [bootstrapping](../advanced/bootstrapping.mdx).
...
Continue to [Stage 1 · PRD](./stage-1-prd.mdx).
