...
| 9 | `FORGE-105` | feature-forge | ACTIVE | `FORGE-102`, `FORGE-103`, `FORGE-104` | Implement and runtime-prove fresh project/personal installs with one complete runtime bundle per scope; only then mark confidence `verified-current`. |
