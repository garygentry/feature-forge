...
| 8 | `FORGE-104` | feature-forge | ACTIVE | `FORGE-101` | Add recursive skill and agent mirror placements with containment, dry-run parity, copy/symlink behavior, manifest ownership, exact uninstall, and conservative explicit Copilot detection. |
