...
| 5 | `FORGE-101` | feature-forge | ACTIVE | `TRACK-001` | Finish distribution-aware invocation/reference translation. Accurately classify the current manifest as legacy Copilot format, or migrate and runtime-prove actual Agent Plugins 1.0 schema/layout; do not claim 1.0 from the current seven-field manifest. |
