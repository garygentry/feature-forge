...
| 7 | `FORGE-103` | feature-forge | ACTIVE | `FORGE-101` | Dirty-tree implementation and evidence now pass 815 focused tests; Copilot CLI 1.0.80 managed-plugin, personal-direct, nested-project, and explicit-override probes; cleanup; and the clean-shell full gate (2,496 Python, 182 installer, 11 Pi source tests). Still requires authorized push and fresh-clone durability. Evidence: `evidence/forge-103-runtime-root-resolution-2026-08-26.md`. Do not depend on `PLUGIN_ROOT`. |
...
| 2026-08-26 | `FORGE-103` | Dirty-tree runtime-root implementation adds neutral override precedence, Copilot managed/personal and nested-project roots, project-over-global Copilot bootstrap ordering, adversarial-path coverage, and preserved degraded handling. Copilot CLI 1.0.80 passed managed-plugin, personal-direct, nested-project, and explicit-override probes; 815 focused tests, cleanup, drift checks, and the full clean-shell gate pass. | feature-forge base `93de3c9`; rauf unchanged at `8d65441` | Keep `FORGE-103` ACTIVE pending authorized push and fresh-clone durability. Evidence: `evidence/forge-103-runtime-root-resolution-2026-08-26.md`. |
