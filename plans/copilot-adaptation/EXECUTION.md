...
| 8 | `FORGE-104` | feature-forge | ACTIVE | `FORGE-101` | Local implementation and evidence pass: recursive/flat Copilot mirrors, trusted containment, dry-run reports, copy/symlink/Windows behavior, non-ownership of pre-existing files, exact uninstall, and generic-`.github` negative detection. Await authorized commit/push and fresh-clone proof before DONE. Evidence: `evidence/forge-104-installer-placement-primitives-2026-08-26.md`. |
...
| 2026-08-26 | `FORGE-104` | Uncommitted installer implementation adds recursive native skills, flat Copilot agents, trusted placement containment, complete proven ownership, dry-run placement reporting, exact update/uninstall, Windows copy fallback, and conservative detection. Independent-review P1s were fixed; clean-shell full gate passes 2,496 Python (2 skipped), 201 installer, and 11 Pi-source tests. | feature-forge dirty tree on `6a9c8a1`; rauf unchanged | Keep `FORGE-104` ACTIVE pending explicit commit/push authorization and fresh-clone verification. Evidence: `evidence/forge-104-installer-placement-primitives-2026-08-26.md`. |
