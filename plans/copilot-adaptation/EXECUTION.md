...
| 7 | `FORGE-103` | feature-forge | ACTIVE | `FORGE-101` | Resolve runtime assets by self-location and explicit `FEATURE_FORGE_ROOT` across plugin/project/personal/subdirectory layouts; test complete/degraded roots, spaces, metacharacters, and existing hosts. Do not depend on `PLUGIN_ROOT`. |
