...
| 5 | `FORGE-101` | feature-forge | ACTIVE | `TRACK-001` | Local implementation, runtime evidence, and clean-shell full gate complete; pending authorized commit/push durability. Copilot prose uses distribution-neutral `invoke-skill:` notation with explicit plugin/direct overlay forms; the current five-field manifest remains the runtime-proven legacy Copilot format and does not claim Agent Plugins 1.0. Receipt: `evidence/forge-101-native-skills-invocation-2026-08-25.md`. |
...
| 2026-08-25 | `FORGE-101` | Implemented distribution-neutral Copilot invocation notation across descriptions, bodies, references, and scripted exits; retained and accurately classified the five-field legacy Copilot manifest; installed/runtime-proved 13 skills and the plugin/direct overlay contract on CLI 1.0.80; passed the clean-shell full gate (2,481 Python, 182 installer, 11 Pi source tests). Disposable plugin/marketplace/temp state was removed. | feature-forge dirty tree based on `12e5266`; rauf unchanged at `8d65441` | Keep `FORGE-101` ACTIVE until explicit commit/push authorization and fresh-clone durability; do not start `FORGE-102`. |
