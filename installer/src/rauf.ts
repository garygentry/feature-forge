 ...
 * known-compatible rauf (REQ-RAUF-03). The current rauf version is 0.11.0.
 *
 * rauf is now PUBLISHED (rauf#28): `@garygentry/rauf@0.11.0` resolves from the npm registry, so the
 ...
 */
export const RAUF_PIN = "@garygentry/rauf@0.11.0";
 ...
 *
 * @param coordinate - the `name@version` to resolve, e.g. "@garygentry/rauf@0.11.0"
