 ...
 *
 * rauf is now PUBLISHED (rauf#28): `@garygentry/rauf@0.15.0` resolves from the npm registry, so the
 ...
 */
export const RAUF_PIN = "@garygentry/rauf@0.15.0";
 ...
 *
 * @param coordinate - the `name@version` to resolve, e.g. "@garygentry/rauf@0.15.0"
