...
| REQ-ROUTE-01 | `02-stage-exit-routing.md` §3, §7 — explicit served stage | `07-testing-strategy.md` §3.2 |
...
| REQ-ROUTE-04 | `02-stage-exit-routing.md` §7 — verify/fix/re-verify rejoin table | `07-testing-strategy.md` §3.3, §7 |
| REQ-ROUTE-05 | `02-stage-exit-routing.md` §7 — complete fix outcome matrix | `07-testing-strategy.md` §3.3 |
| REQ-ROUTE-06 | `02-stage-exit-routing.md` §7 — complete verify outcome matrix | `07-testing-strategy.md` §3.3 |
| REQ-PROD-01 | `02-stage-exit-routing.md` §8; `04-skill-integration.md` §6 — all loop outcomes | `07-testing-strategy.md` §3.5, §6.2 |
| REQ-PROD-02 | `02-stage-exit-routing.md` §8 — non-complete recovery without advancement | `07-testing-strategy.md` §3.5 |
| REQ-PROD-03 | `02-stage-exit-routing.md` §9; `04-skill-integration.md` §7 — scripted docs exit | `07-testing-strategy.md` §3.6, §6.1 |
| REQ-PROD-04 | `02-stage-exit-routing.md` §9 — standalone/epic docs handoff | `07-testing-strategy.md` §3.6 |
...
| Live epic/docs and loop outcome routing | `02-stage-exit-routing.md` §8–§9; `04-skill-integration.md` §6–§8 |
...
- All 53 PRD requirement IDs have at least one primary implementation mapping.
