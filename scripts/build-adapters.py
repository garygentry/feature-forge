...
_HOST_NOTES_CODEX = (
    ...
    "- **User input:** Codex has no structured question tool. Interactive session — "
    "ask the question directly and wait for the reply; never assume an answer. Under "
    "`codex exec` (non-interactive) — don't wait: take the Interaction Capability "
...
_HOST_NOTES_NEUTRAL = (
    ...
    "runtime can prompt and wait; never assume one. When your runtime is genuinely "
...
_HOST_NOTES_PI = (
    ...
    "the tool list; a call attempted anyway fails with `Error: UI not available "
