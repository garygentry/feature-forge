...
| Loop runner interface & signals | `references/ralph-loop-contract.md` |
| Version compatibility (forge ↔ rauf) | `COMPATIBILITY.md` |
| Deep dives, glossary, troubleshooting | `README.md`, `docs-site/src/content/docs/**` |
...
a minimum runner version (see `COMPATIBILITY.md`).
...
- **Stage 5 won't start:** backlog exists and is verified? runner installed and ≥ min version?
  working tree clean? See `COMPATIBILITY.md` and `references/ralph-loop-contract.md`.
...
For anything deeper, point the user to `README.md`, `references/process-overview.md`, or the
relevant page under `docs-site/src/content/docs/`.
