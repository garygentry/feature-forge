...
- Use `/skill:forge` to enter the forge pipeline for new features.
...
- **Where to file** — route by which tool the friction is with:
  - feature-forge (pipeline stages, `/skill:*`, forge skills/agents): https://github.com/garygentry/feature-forge/issues
