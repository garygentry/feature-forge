// GENERATED — DO NOT EDIT. Source: adapter-src/pi/extensions/ask-user-question/ask-user-question.ts
...
export const ASK_USER_QUESTION_TOOL_NAME = "AskUserQuestion"; // FEATURE-FORGE VENDOR PATCH: Claude-parity name
