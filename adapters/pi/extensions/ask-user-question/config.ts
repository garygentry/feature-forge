// GENERATED — DO NOT EDIT. Source: adapter-src/pi/extensions/ask-user-question/config.ts
// Regenerate with: python3 scripts/build-adapters.py
// FEATURE-FORGE VENDOR PATCH: upstream imports these from @juicesharp/rpiv-config.
import type { GuidanceFields } from "./vendor-config-shim.js";
import { loadJsonConfigWithLegacyFallback, validateGuidanceFields } from "./vendor-config-shim.js";
