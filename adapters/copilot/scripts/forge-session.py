...
try:
    ...
    # VerifyStatus is read by get_args at module load; _default_branch is called by
    # the still-inline doctor_report, which the bare-dir doctor tests invoke). The
    # package-present branch above is authoritative; these are byte-equal fallbacks,
