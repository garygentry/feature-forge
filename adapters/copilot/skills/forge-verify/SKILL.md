...
name: forge-verify
description: 'Verify forge pipeline artifacts for completeness, consistency, and quality. Use when user runs invoke-skill: forge-verify or asks to check forge specs, backlog, or implementation for gaps. Do NOT trigger for general code review, quality checks, or verification tasks outside the forge pipeline.'
