...
needs a session clear, and it's safe to automate with `autoVerify: true`. When on, the just-completed
...
- **Anything environmental:** run `/feature-forge:forge-guide --doctor` — it reports every
