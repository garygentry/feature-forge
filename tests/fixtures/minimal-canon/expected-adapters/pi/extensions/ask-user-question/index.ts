...
import { dirname } from "node:path"; // FEATURE-FORGE VENDOR PATCH
import { fileURLToPath } from "node:url"; // FEATURE-FORGE VENDOR PATCH
...
export default function (pi: ExtensionAPI) {
	// FEATURE-FORGE VENDOR PATCH: seed the bundle root so generated forge shell
	// snippets prefer this active Pi adapter over unrelated local installs.
	process.env.FEATURE_FORGE_ROOT ||= dirname(dirname(dirname(fileURLToPath(import.meta.url))));
